...
class ArticleServiceTest {
    ...
    @DisplayName("게시글 정보를 입력하면, 게시글을 작성한다.")
    @Test
    void givenArticleInfo_whenSavingArticle_thenSaveArticle(){
        ...
        //When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "Duzi", "title", "content", "#java"));
    ...
    @Test
    void givenArticleInfoAndModifiedInfo_whenUpdatingArticle_thenUpdateArticle(){
        //Given
        given(articleRepository.save(any(Article.class))).willReturn(null);
